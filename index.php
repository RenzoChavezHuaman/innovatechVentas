...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Los mejores en Tecnologia</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Tienda Innovatech</h1>
                <p class="lead fw-normal text-white-50 mb-0">Los mejores productos informaticos</p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Integrador II</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
